 ...
 *
 * @providesModule RNWebViewAndroid
 */
"use strict";
import {
...
var RCT_WEBVIEW_REF = "RNWebViewAndroid";
...
class WebViewAndroid extends React.Component {
  ...
  render() {
    ...
    if (this.state.viewState === WebViewState.LOADING) {
      ...
      console.error(
        "RNWebViewAndroid invalid state encountered: " + this.state.loading
      );
    }
  ...
  postMessage = data => {
    UIManager.dispatchViewManagerCommand(
      this.getWebViewHandle(),
      UIManager.RNWebViewAndroid.Commands.postMessage,
      [String(data)]
    );
  };
  /**
  ...
  */
  injectJavaScript = data => {
    UIManager.dispatchViewManagerCommand(
      this.getWebViewHandle(),
      UIManager.RNWebViewAndroid.Commands.injectJavaScript,
      [data]
    );
  };
  /**
...
var RNWebViewAndroid = requireNativeComponent(
  "RNWebViewAndroid",
  WebViewAndroid,
  {
    nativeOnly: {
